...
names_input = st.text_area("พิมพ์รายชื่อ คั่นด้วยเครื่องหมายจุลภาค ,", "วิน,โต๊ด,ติน,ต่อ,มุก,เฟิร์น,กันดั้ม,โก้")
players = [n.strip() for n in names_input.split(",") if n.strip()]
